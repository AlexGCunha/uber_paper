  ...
  for(s in 1:2){
    ...
    privado_baixo_sal = rais_s[privado == 1 & valor_remuneracao_media <= 3000, 
                        .(emprego_baixo_sal = sum(empregado), 
                          tenure_baxo_sal = mean(tempo_emprego), 
    ...
    rm(combinado, municipios, privado, privado_baixo_sal, privado_alto_sal,
       privado_homens, privado_mulheres, privado_nao_brancos, publico,
